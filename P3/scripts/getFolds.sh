...
#            technique.
sed -n 1,50p data/iris-shuffled.txt > 1stfold_heldout.txt
sed -n 51,150p data/iris-shuffled.txt > 1stfold_train.txt

sed -n 51,100p data/iris-shuffled.txt > 2stfold_heldout.txt
sed -n 1,50p data/iris-shuffled.txt >> 2stfold_train.txt
sed -n 101,150p data/iris-shuffled.txt >> 2stfold_train.txt

sed -n 101,150p data/iris-shuffled.txt > 3rdfold_heldout.txt
sed -n 1,100p data/iris-shuffled.txt > 3rdfold_train.txt
